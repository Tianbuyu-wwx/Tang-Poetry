...
CLASSICAL_PREFIXES = [
    ...
    "唐诗品汇","沧浪诗话","六一诗话","世说新语","酉阳杂俎","博物志","搜神记",
    "风土记","荆楚岁时记","三秦记","洛阳伽蓝记","穆天子传","战国策","公羊传",
    "谷梁传","左氏传","左传","春秋","论语","孟子","荀子","老子","庄子","列子",
    "韩非子","管子","晏子春秋","墨子","尉缭子","商君书","抱朴子","文子","鹖冠子",
    "文选","尚书","周礼","仪礼","尔雅","说文","诗经","楚辞","易","书","礼",
    "傅咸","陶潜","陶渊明","谢朓","谢灵运","谢惠连","谢庄","鲍照","沈约","江淹",
    "庾信","徐陵","江总","阴铿","何逊","吴均","王褒","王融","范云","任昉","丘迟",
    "郦道元","刘勰","钟嵘","萧统","萧纲","萧绎","梁武帝","梁元帝","梁简文帝",
    "陈后主","宋之问","沈佺期","王勃","杨炯","卢照邻","骆宾王","陈子昂","杜审言",
    "李峤","虞世南","上官仪","太宗皇帝","高宗皇帝","李白","杜甫","王维","孟浩然",
    "王昌龄","高适","岑参","李颀","崔颢","王之涣","王翰","张说","张九龄","贺知章",
    "孟郊","贾岛","韩愈","柳宗元","刘禹锡","白居易","元稹","张籍","王建","李绅",
    "杜牧","李商隐","温庭筠","韦庄","司空图","韩偓","罗隐","聂夷中","杜荀鹤","许浑",
    "皮日休","陆龟蒙","齐己","曹植","曹丕","曹操","王粲","刘桢","阮籍","嵇康",
    "陆机","陆云","潘岳","张协","左思","刘琨","郭璞","孙绰","许询","应玚"
]
...
with open('tmp_split_js_out.txt', 'w', encoding='utf-8') as f:
    f.write('\n'.join(out))
print('done')
