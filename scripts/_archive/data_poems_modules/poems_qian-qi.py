# -*- coding: utf-8 -*-
"""
钱起卷 · 全唐诗诗作（自动解析自《全唐诗》曹寅本）
共 422 首。原文据《全唐诗》，重点名篇注释赏析据《唐诗鉴赏辞典》等权威典籍。
"""
...
POEMS_LOCAL = [
    ...
    # ---------- 49. 山中春仲寄汝上王恒、颍川沈冲（一作中） ----------
    {
        "id": "qian-qi-49",
        "title": "山中春仲寄汝上王恒、颍川沈冲（一作中）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 68. 太子李舍人城东别业（李祭酒别业俯视川林前带雷岫） ----------
    {
        "id": "qian-qi-68",
        "title": "太子李舍人城东别业（李祭酒别业俯视川林前带雷岫）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 73. 裴侍郎湘川回，以青竹筒相遗，因而赠之 ----------
    {
        "id": "qian-qi-73",
        "title": "裴侍郎湘川回，以青竹筒相遗，因而赠之",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 88. 归义寺题震上人壁（寺即神尧皇帝读书之所） ----------
    {
        "id": "qian-qi-88",
        "title": "归义寺题震上人壁（寺即神尧皇帝读书之所）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 109. 哭空寂寺玄上人（一作少林寺哭晖上人） ----------
    {
        "id": "qian-qi-109",
        "title": "哭空寂寺玄上人（一作少林寺哭晖上人）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 124. 裴迪南门秋夜对月（一作裴迪书斋玩月之作） ----------
    {
        "id": "qian-qi-124",
        "title": "裴迪南门秋夜对月（一作裴迪书斋玩月之作）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 126. 晚归蓝田，酬王维给事（一作中书常舍人）赠别 ----------
    {
        "id": "qian-qi-126",
        "title": "晚归蓝田，酬王维给事（一作中书常舍人）赠别",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 127. 再得华侍御书，闻巴中卧病（一作疾） ----------
    {
        "id": "qian-qi-127",
        "title": "再得华侍御书，闻巴中卧病（一作疾）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 144. 岁初归旧山（又作献岁初归旧居酬皇甫侍御见寄） ----------
    {
        "id": "qian-qi-144",
        "title": "岁初归旧山（又作献岁初归旧居酬皇甫侍御见寄）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 218. 咏门上画松，上元、王、杜三相公（一作崔峒诗） ----------
    {
        "id": "qian-qi-218",
        "title": "咏门上画松，上元、王、杜三相公（一作崔峒诗）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 224. 见上林春雁翔青云，寄杨起居、李员外 ----------
    {
        "id": "qian-qi-224",
        "title": "见上林春雁翔青云，寄杨起居、李员外",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 268. 春暮过石龟谷题温处士林园（一作送温逸人） ----------
    {
        "id": "qian-qi-268",
        "title": "春暮过石龟谷题温处士林园（一作送温逸人）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 279. 李四劝为尉氏尉，李七勉为开封尉（惟伯与仲有令誉） ----------
    {
        "id": "qian-qi-279",
        "title": "李四劝为尉氏尉，李七勉为开封尉（惟伯与仲有令誉）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 305. 太子李舍人城东别业与二三文友逃暑 ----------
    {
        "id": "qian-qi-305",
        "title": "太子李舍人城东别业与二三文友逃暑",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 306. 柏崖老人号无名先生男削发女黄冠自以云泉独乐命予赋诗 ----------
    {
        "id": "qian-qi-306",
        "title": "柏崖老人号无名先生男削发女黄冠自以云泉独乐命予赋诗",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 312. 奉和中书常舍人晚秋集贤院即事寄徐薛二侍御 ----------
    {
        "id": "qian-qi-312",
        "title": "奉和中书常舍人晚秋集贤院即事寄徐薛二侍御",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 313. 和范郎中宿直中书，晓玩清池，赠南省同僚两垣遗补 ----------
    {
        "id": "qian-qi-313",
        "title": "和范郎中宿直中书，晓玩清池，赠南省同僚两垣遗补",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 317. 题郎士元半日吴村别业，兼呈李长官 ----------
    {
        "id": "qian-qi-317",
        "title": "题郎士元半日吴村别业，兼呈李长官",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 318. 猷川雪后送僧粲临还京，时避世卧疾 ----------
    {
        "id": "qian-qi-318",
        "title": "猷川雪后送僧粲临还京，时避世卧疾",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 340. 幽居春暮书怀（一作石门暮春，一作蓝田春暮） ----------
    {
        "id": "qian-qi-340",
        "title": "幽居春暮书怀（一作石门暮春，一作蓝田春暮）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 343. 酬考功杨员外见赠佳句(黄卷读来今已老白头受屈不曾言) ----------
    {
        "id": "qian-qi-343",
        "title": "酬考功杨员外见赠佳句(黄卷读来今已老白头受屈不曾言)",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 348. 同王錥起居程浩郎中韩翃舍人题安国寺用上人院 ----------
    {
        "id": "qian-qi-348",
        "title": "同王錥起居程浩郎中韩翃舍人题安国寺用上人院",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 356. 登刘宾客高斋（时公初退相，一作春题刘相公山斋） ----------
    {
        "id": "qian-qi-356",
        "title": "登刘宾客高斋（时公初退相，一作春题刘相公山斋）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 379. 蓝田溪杂咏二十二首·登台（一作望山台） ----------
    {
        "id": "qian-qi-379",
        "title": "蓝田溪杂咏二十二首·登台（一作望山台）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 384. 蓝田溪杂咏二十二首·洞仙谣（一作伺山径） ----------
    {
        "id": "qian-qi-384",
        "title": "蓝田溪杂咏二十二首·洞仙谣（一作伺山径）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 393. 蓝田溪杂咏二十二首·东陂（一作忆皇子陂） ----------
    {
        "id": "qian-qi-393",
        "title": "蓝田溪杂咏二十二首·东陂（一作忆皇子陂）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 405. 暮春归故山草堂（一作刘长卿诗：晚春归山居题窗前竹） ----------
    {
        "id": "qian-qi-405",
        "title": "暮春归故山草堂（一作刘长卿诗：晚春归山居题窗前竹）",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 408. 故王维右丞堂前芍药花开，凄然感怀 ----------
    {
        "id": "qian-qi-408",
        "title": "故王维右丞堂前芍药花开，凄然感怀",
        "author": "钱起",
        "poet_id": "qian-qi",
        "dynasty": "唐",
        "genre": "古诗",
