# -*- coding: utf-8 -*-
"""
杜甫卷 · 全唐诗诗作（自动解析自《全唐诗》曹寅本）
共 1151 首。原文据《全唐诗》，重点名篇注释赏析据《唐诗鉴赏辞典》等权威典籍。
"""
...
POEMS_LOCAL = [
    ...
    # ---------- 964. 简吴郎司法 ----------
    {
        ...
        "source": "《全唐诗·卷38》",
        "verse": [
            "有客乘舸自忠州，遣骑安置瀼西头。古堂本买藉疏豁，",
            "借汝迁居停宴游。云石荧荧高叶曙，风江飒飒乱帆秋。",
            "却为br>兰若山高处，烟霞嶂几重。冻泉依细石，晴雪落长松。",
    ...
    # ---------- 1002. 送大理封主簿五郎亲事不合却赴通州主簿前阆…亲事遂停 ----------
    {
        "id": "du-fu-1002",
    ...
    # ---------- 1006. 大历三年春白帝城放船出瞿塘峡久居夔府将适…凡四十韵 ----------
    {
        "id": "du-fu-1006",
    ...
    # ---------- 1036. 秋日荆南送石首薛明府辞满告别奉寄薛尚书颂德…三十韵 ----------
    {
        "id": "du-fu-1036",
