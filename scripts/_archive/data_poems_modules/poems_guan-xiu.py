# -*- coding: utf-8 -*-
"""
贯休卷 · 全唐诗诗作（自动解析自《全唐诗》曹寅本）
共 553 首。原文据《全唐诗》，重点名篇注释赏析据《唐诗鉴赏辞典》等权威典籍。
"""
...
POEMS_LOCAL = [
    ...
    # ---------- 97. 大蜀皇帝寿春节进尧铭舜颂二首·尧铭 ----------
    {
        "id": "guan-xiu-97",
        "title": "大蜀皇帝寿春节进尧铭舜颂二首·尧铭",
        "author": "贯休",
        "poet_id": "guan-xiu",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 98. 大蜀皇帝寿春节进尧铭舜颂二首·舜颂 ----------
    {
        "id": "guan-xiu-98",
        "title": "大蜀皇帝寿春节进尧铭舜颂二首·舜颂",
        "author": "贯休",
        "poet_id": "guan-xiu",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 113. 将入匡山别芳昼二公二首（一作将入庐山别僧） ----------
    {
        "id": "guan-xiu-113",
        "title": "将入匡山别芳昼二公二首（一作将入庐山别僧）",
        "author": "贯休",
        "poet_id": "guan-xiu",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 248. 闻赤松舒道士下世（东阳未乱前相别） ----------
    {
        "id": "guan-xiu-248",
        "title": "闻赤松舒道士下世（东阳未乱前相别）",
        "author": "贯休",
        "poet_id": "guan-xiu",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 321. 避地毗陵上王慥使君（时黄贼陷东阳公避地于浙右） ----------
    {
        "id": "guan-xiu-321",
        "title": "避地毗陵上王慥使君（时黄贼陷东阳公避地于浙右）",
        "author": "贯休",
        "poet_id": "guan-xiu",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 482. 鹭鸶有怀（前东阳王慥使君养一鹭鸶名瑶花） ----------
    {
        "id": "guan-xiu-482",
        "title": "鹭鸶有怀（前东阳王慥使君养一鹭鸶名瑶花）",
        "author": "贯休",
        "poet_id": "guan-xiu",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 485. 避地毗陵，寒月上孙徽使君兼寄东阳王使君三首 ----------
    {
        "id": "guan-xiu-485",
        "title": "避地毗陵，寒月上孙徽使君兼寄东阳王使君三首",
        "author": "贯休",
        "poet_id": "guan-xiu",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 539. 悼张道古（昭宗时道古官拾遗以直谏贬蜀中死） ----------
    {
        "id": "guan-xiu-539",
        "title": "悼张道古（昭宗时道古官拾遗以直谏贬蜀中死）",
        "author": "贯休",
        "poet_id": "guan-xiu",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 552. 句 ----------
    {
        ...
        "verse": [
            ...
            "有事，辄云待钱来，后果以钱镠代之。此上钱镠句也）雁荡经行云漠漠，龙湫宴坐雨濛濛。（雁荡山今有经行台、",
            "宴坐峰，皆以休得名）",
            "刻成筝柱雁相挨。",
            "黄昏风雨黑如磐，别我不知何处去。（《侠客》，",
            "见《剑侠传》）",
