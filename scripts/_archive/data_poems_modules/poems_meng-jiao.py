# -*- coding: utf-8 -*-
"""
孟郊卷 · 全唐诗诗作（自动解析自《全唐诗》曹寅本）
共 402 首。原文据《全唐诗》，重点名篇注释赏析据《唐诗鉴赏辞典》等权威典籍。
"""
...
POEMS_LOCAL = [
    ...
    # ---------- 74. 戏赠陆大夫十二丈（一作乐府戏赠陆大夫十二丈） ----------
    {
        "id": "meng-jiao-74",
        "title": "戏赠陆大夫十二丈（一作乐府戏赠陆大夫十二丈）",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 103. 夷门雪赠主人（是赠陆长源，陆有答诗） ----------
    {
        "id": "meng-jiao-103",
        "title": "夷门雪赠主人（是赠陆长源，陆有答诗）",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 138. 夜感自遣（一作失志夜坐思归楚江，又作苦学吟） ----------
    {
        "id": "meng-jiao-138",
        "title": "夜感自遣（一作失志夜坐思归楚江，又作苦学吟）",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 151. 乙酉岁舍弟扶侍归兴义庄居后独止舍待替人 ----------
    {
        "id": "meng-jiao-151",
        "title": "乙酉岁舍弟扶侍归兴义庄居后独止舍待替人",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 192. 题韦承总吴王故城下幽居（韦生，相门子孙） ----------
    {
        "id": "meng-jiao-192",
        "title": "题韦承总吴王故城下幽居（韦生，相门子孙）",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 213. 分水岭别夜示从弟寂（一作示于孟叔） ----------
    {
        "id": "meng-jiao-213",
        "title": "分水岭别夜示从弟寂（一作示于孟叔）",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 228. 抒情因上郎中二十二叔监察十五叔兼呈李益端公柳缜评事 ----------
    {
        "id": "meng-jiao-228",
        "title": "抒情因上郎中二十二叔监察十五叔兼呈李益端公柳缜评事",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 243. 大隐坊·章仇将军良弃功守贫（一作赠章仇兵马使） ----------
    {
        "id": "meng-jiao-243",
        "title": "大隐坊·章仇将军良弃功守贫（一作赠章仇兵马使）",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 249. 舟中喜遇从叔简别后寄上时从叔初擢第归江南郊不从行 ----------
    {
        "id": "meng-jiao-249",
        "title": "舟中喜遇从叔简别后寄上时从叔初擢第归江南郊不从行",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 271. 汝坟蒙从弟楚材见赠，时郊将入秦，楚材适楚 ----------
    {
        "id": "meng-jiao-271",
        "title": "汝坟蒙从弟楚材见赠，时郊将入秦，楚材适楚",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 280. 送无怀道士游富春山水（一作送别吴逸士归山） ----------
    {
        "id": "meng-jiao-280",
        "title": "送无怀道士游富春山水（一作送别吴逸士归山）",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 286. 送清远上人归楚山旧寺（一作国清上人游苏、送溪上人） ----------
    {
        "id": "meng-jiao-286",
        "title": "送清远上人归楚山旧寺（一作国清上人游苏、送溪上人）",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 293. 春日同韦郎中使君送邹儒立少府扶侍赴云阳 ----------
    {
        "id": "meng-jiao-293",
        "title": "春日同韦郎中使君送邹儒立少府扶侍赴云阳",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 302. 和薛先辈送独孤秀才上都赴嘉会得青字 ----------
    {
        "id": "meng-jiao-302",
        "title": "和薛先辈送独孤秀才上都赴嘉会得青字",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 305. 同李益、崔放送王炼师还楼观，兼为群公先营山居 ----------
    {
        "id": "meng-jiao-305",
        "title": "同李益、崔放送王炼师还楼观，兼为群公先营山居",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 311. 溧阳唐兴寺观蔷薇花，同诸公饯陈明府 ----------
    {
        "id": "meng-jiao-311",
        "title": "溧阳唐兴寺观蔷薇花，同诸公饯陈明府",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 317. 送陆畅归湖州，因凭题故人皎然塔、陆羽坟 ----------
    {
        "id": "meng-jiao-317",
        "title": "送陆畅归湖州，因凭题故人皎然塔、陆羽坟",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 321. 送郑仆射出节山南（一作酬郑兴元仆射招） ----------
    {
        "id": "meng-jiao-321",
        "title": "送郑仆射出节山南（一作酬郑兴元仆射招）",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 373. 上昭成阁不得，于从侄僧悟空院叹嗟 ----------
    {
        "id": "meng-jiao-373",
        "title": "上昭成阁不得，于从侄僧悟空院叹嗟",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 395. 杏殇（杏殇，花乳也，霜翦而落，因悲昔婴，故作是诗） ----------
    {
        "id": "meng-jiao-395",
        "title": "杏殇（杏殇，花乳也，霜翦而落，因悲昔婴，故作是诗）",
        "author": "孟郊",
        "poet_id": "meng-jiao",
        "dynasty": "唐",
        "genre": "古诗",
