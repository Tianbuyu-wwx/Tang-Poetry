# -*- coding: utf-8 -*-
"""
沈佺期卷 · 全唐诗诗作（自动解析自《全唐诗》曹寅本）
共 171 首。原文据《全唐诗》，重点名篇注释赏析据《唐诗鉴赏辞典》等权威典籍。
"""
...
POEMS_LOCAL = [
    ...
    # ---------- 69. 和洛州康士曹庭芝望月有怀（一作康庭芝或宋之问诗） ----------
    {
        "id": "shen-quan-qi-69",
        "title": "和洛州康士曹庭芝望月有怀（一作康庭芝或宋之问诗）",
        "author": "沈佺期",
        "poet_id": "shen-quan-qi",
        "dynasty": "唐",
        "genre": "古诗",
    ...
    # ---------- 121. 古意呈补阙乔知之（一作古意，又作独不见） ----------
    {
        "id": "shen-quan-qi-121",
        "title": "古意呈补阙乔知之（一作古意，又作独不见）",
        "author": "沈佺期",
        "poet_id": "shen-quan-qi",
        "dynasty": "唐",
        "genre": "古诗",
