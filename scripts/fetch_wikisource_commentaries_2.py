# -*- coding: utf-8 -*-
"""下载并整理中文维基文库中的两部公版诗人别集注本。

- 《杜詩詳註》（清·仇兆鰲撰）二十五卷
- 《李太白集分類補註》（宋·楊齊賢集註，元·蕭士贇補註）三十卷

两部书均以〈尖括號〉保存大量逐句箋釋、典故出處與異文校語，
版式穩定，可直接使用 import_docs.py 的 angle-comment 管線掛接。
"""
...
OUTPUT_DIR = ROOT / "docs" / "tang_commentaries_public_domain_5"
...
WORKS = [
    {
        ...
        "author": "清·仇兆鰲撰",
        "edition": "四庫全書本",
        "description": "二十五卷；即《杜少陵集详注》，逐篇繫年、箋釋字句、博引典故，是杜詩最詳備的古代注本之一。",
        "source_url": "https://zh.wikisource.org/wiki/杜詩詳註_(四庫全書本)",
        "pages": [f"杜詩詳註 (四庫全書本)/卷{i:02d}" for i in range(1, 26)],
    },
    {
        "id": "li_taibai_ji_fenlei_buzhu",
        "title": "李太白集分類補註",
        "author": "宋·楊齊賢集註，元·蕭士贇補註",
        "edition": "四庫全書本",
        "description": "三十卷；按體裁分類，楊齊賢集註、蕭士贇補註，保存李白詩大量典故箋釋與異文校語。",
        "source_url": "https://zh.wikisource.org/wiki/李太白集分類補註_(四庫全書本)",
        "pages": [f"李太白集分類補註 (四庫全書本)/卷{i:02d}" for i in range(1, 31)],
    },
]
